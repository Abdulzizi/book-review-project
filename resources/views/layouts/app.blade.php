...
<head>
    ...
    <style type="text/tailwindcss">
      ...
      .book-item {
          @apply text-sm rounded-md bg-white p-4 leading-6 text-slate-900 shadow-lg shadow-black/5 ring-1 ring-slate-700/10;
      }
      ...
      .empty-book-item {
          @apply text-sm rounded-md bg-white py-10 px-4 text-center leading-6 text-slate-900 shadow-xl shadow-black/5 ring-1 ring-slate-700/10;
      }
